...
from .views import RegisterView, LoginView, RecordingListView, RecordingDetailView, FolderListView, FolderDetailView, SharedRecordingListView, UserSearchView, RecordingShareView
